...
- **5 次正式作业**逐题拆分：`solutions/01` … `05`；第四次作业已拆为 Lec17-18 / Lec19-20 模块
- **`06-考前复习`**：电子板串讲习题索引 + 缺口标准解答（非第六次作业 PDF，侧栏标签「考前复习 · 串讲习题」）
- **2 个实验**模块 + 指南/附录矩阵
...
### P4-3 呈现层增强（来自 SITE_RESEARCH 候选） ✅（2026-06-10）

- 公式密集页「公式卡片」抽取视图（`99-公式与图像.md` + `99-自检` 必背公式段，≥2 卡启用速查切换）
