...
考前公式卡集中入口。符号与 [第一次作业符号导读](../01-传输线基础/00-符号与导读.md) 一致（$Z_c$；部分题写 $Z_0$ 同义）；更完整的 13 项划重点见 [考前复习总览](../../guide/exam-review.md)。口诀与闭卷默写见 [公式记忆专章](../../guide/公式记忆/README.md)。
...
## 波导与谐振腔公式汇总（BLQ p41） {#wg-cavity-formulas}
