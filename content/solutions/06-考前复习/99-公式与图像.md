...
考前公式卡集中入口。符号与 [第一次作业符号导读](../01-传输线基础/00-符号与导读.md) 一致（$Z_c$；部分题写 $Z_0$ 同义）；更完整的 13 项划重点见 [考前复习总览](../../guide/exam-review.md)。
...
| 谐振/网络 Lec22–28 | [04-后续 · 99-公式](../04-后续专题/99-公式与图像.md)、[08 · 99-自检](../../knowledge/08-谐振器网络与课程综合/99-自检清单与常见误区.md) |
