...
![TEM、TE、TM 三类波型的纵向场分量对比](../../../assets/images/gpt-hw3-wave-types-tem-te-tm.png)
...
![分离变量法：先解纵向种子分量，再得到横截面本征值](../../../assets/images/gpt-wg-longitudinal-separation.png)
...
![从 $\mathrm{TM}_{11}$ 的 $E_z$ 推到全场分量](../../../assets/images/gpt-wg-tm11-ez-to-full-field.png)
