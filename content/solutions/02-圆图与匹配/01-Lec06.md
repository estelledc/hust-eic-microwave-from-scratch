...
![Lec06-1 电压电流幅值分布](../../../assets/images/lec06_q1_voltage_current.png)
...
![Lec06 第 2 题：用线长把端口变成开路或短路](../../../assets/images/gpt-hw2-lec06-q2-open-short-lengths.png)
...
![Lec06 第 3 题：由反射系数映射到归一化负载阻抗](../../../assets/images/gpt-hw2-lec06-q3-gamma-to-zbar.png)
...
![Lec06-4：$A$、$B$ 与 $\lambda/4$ 间距示意](../../../assets/images/lec06_q4_quarter_wave_AB.png)
...
![第一波节位置 $z_{\min}$ 示意（$\rho=2$、$z_{\min}=0.1\lambda$ 举例）](../../../assets/images/lec_vmin_first_null.png)
