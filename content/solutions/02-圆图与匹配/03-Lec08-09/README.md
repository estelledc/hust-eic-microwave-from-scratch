...
**串讲习题对照**：习 1-8 → [Lec04 · 第 4 题](../../01-传输线基础/04-Lec04.md)；圆图综合；$\lambda/4$ 变换；单/双支节与死区；**单支节算例**（$Z_L=50+j25\,\Omega$，$\lambda=10\,\mathrm{cm}$）→ [03 · 并联支节 · 算例](../../../knowledge/02-反射与匹配/03-并联支节匹配.md#stub-matching-example)、[第 4 题](第04题.md)。
