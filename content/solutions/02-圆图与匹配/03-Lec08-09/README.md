...
**BLQ 串讲对照**：p23 习 1-8 → [Lec04 · 第 4 题](../01-传输线基础/04-Lec04.md)；p26–28 圆图综合；p29 $\lambda/4$ 变换；p30–32 单/双支节与死区；**p34 单支节算例**（$Z_L=50+j25\,\Omega$，$\lambda=10\,\mathrm{cm}$）→ [03 · 并联支节 · 算例](../../knowledge/02-反射与匹配/03-并联支节匹配.md#blq-p34-stub-example)、[第 1 题](第01题.md)。
