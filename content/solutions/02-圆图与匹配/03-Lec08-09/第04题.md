...
**工程/物理目标**：把 **任意 $Z_L$** 经 **距负载 $d$ 的截面 + 并联短路支节** 调到 **$Z_c$**，使馈线上反射最小；圆图上即 **$g=1$ 定 $d$、外圆定 $l$**（与 [Lec08–09 总册](README.md) 导读、[第 1 题](第01题.md) **解法二** 同一套路）。
...
![拓扑：并联短路单支节](../../../../assets/images/lec08_study_01_parallel_stub_topology.webp)

![先 $d$ 后 $l$ 的原因（支节只改电纳）](../../../../assets/images/lec08_study_02_why_d_then_l.webp)

![Smith：四步定 $d$、定 $l$](../../../../assets/images/lec08_study_03_smith_four_steps.webp)

![两组解：$g=1$ 两交点示意](../../../../assets/images/lec08_study_04_two_solutions_g1.webp)
...
![Lec08-4：$\bar Y_L$ 与 $g=1$ 的两个交点，对应两组并联短路支节解](../../../../assets/images/smith_lec08_q4_single_stub.webp)
