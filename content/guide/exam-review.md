...
1. **过 13 项核心考点**：每项至少能口述一句，并知道对应知识点页在哪里。
2. **刷串讲习题索引**：按章节找还没掌握的题型，优先缺口题和计算大题。
...
| 资源 | 作用 |
|------|------|
| [公式记忆专章](公式记忆/README.md) | **默写主入口**：口诀、易混对照、闭卷 checklist（第三轮） |
...
避免在多个 `99-公式与图像` 之间来回跳。按任务选入口：

| 你要做什么 | 推荐入口 |
|------------|----------|
| 闭卷默写、口诀、13 项对照 | [公式记忆专章](公式记忆/README.md) |
| 一张表速查 | 本页下方 [必背公式速查](#必背公式速查) |
| 需要更全的汇总表或分作业跳转 | [考前复习 · 公式与图像](../solutions/06-考前复习/99-公式与图像.md) |
| 做某次作业时查该章公式 | 对应作业目录下的 `99-公式与图像`（就地速查） |
| 概念与误区查漏 | 各 knowledge 阶段 `99-自检清单` |
...
| 5 | Smith 圆图 / 双支节死区 | 点线面、单/双支节；**匹配死区**（=盲区）简答 | [Smith 圆图专题](Smith圆图专题/README.md)、[02 · Smith 圆图](../knowledge/02-反射与匹配/02-Smith圆图怎么读.md)、[03 · 死区简答](../knowledge/02-反射与匹配/03-并联支节匹配.md#stub-dead-zone)、[Lec08-09 第 6 题](../solutions/02-圆图与匹配/03-Lec08-09/第06题.md) |
...
更全的公式卡见 [考前复习 · 公式与图像](../solutions/06-考前复习/99-公式与图像.md)（扩展速查；默写主入口仍是 [公式记忆专章](公式记忆/README.md)）。
