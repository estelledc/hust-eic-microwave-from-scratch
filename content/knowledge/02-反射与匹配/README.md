...
`传输线理论 - 圆图.pdf` 和 `阻抗匹配实例.pdf` 已融入本阶段。不要把圆图当成新公式表，它只是在同一张图上同时显示 $\Gamma$、归一化阻抗和沿线旋转。
...
![阻抗匹配实例课件精选页](../../../assets/images/course/course-impedance-matching-examples-source-preview.webp)
