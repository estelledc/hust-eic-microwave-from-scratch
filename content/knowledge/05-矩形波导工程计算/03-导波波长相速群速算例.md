...
**串讲算例**：$23\times10\,\mathrm{mm}$ 铜波导、$10\,\mathrm{GHz}$ $\mathrm{TE}_{10}$ — 先算 $\lambda_{\mathrm c}=4.6\,\mathrm{cm}$，再求 $\lambda_{\mathrm g}$、$v_{\mathrm p}$、$v_{\mathrm g}$、$Z_{\mathrm{TE}}$、$P_{\mathrm{br}}$、$\alpha$ 与传输损耗 $P_L$。步骤与 [Lec13-16 · 第 2 题](../../solutions/03-规则波导与矩形波导/03-Lec13-16/第02题.md) 同型。
